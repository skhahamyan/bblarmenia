...
--
-- Host: localhost    Database: remove
-- ------------------------------------------------------
...
CREATE TABLE `contact` (
  ...
  CONSTRAINT `fk_contact_company_id` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `knowledge` (
  ...
  `speaker_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_knowledge_speaker_id` (`speaker_id`),
  CONSTRAINT `fk_knowledge_speaker_id` FOREIGN KEY (`speaker_id`) REFERENCES `speaker` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `speaker` (
  ...
  `company_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `ux_speaker_credential_id` (`credential_id`),
  KEY `fk_speaker_company_id` (`company_id`),
  CONSTRAINT `fk_speaker_company_id` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`),
  CONSTRAINT `fk_speaker_credential_id` FOREIGN KEY (`credential_id`) REFERENCES `credential` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
